...
export default function Header({myRef}) {
    return (
        <div className="container fixed z-50 max-w-full h-16 flex items-center bg-black text-white" ref={myRef}>   
            ...
            <li className="hover:cursor-pointer hover:text-red-500 flex flex-row items-center justify-center text-lg font-bold"><FontAwesomeIcon icon={faHouseUser} size="2x"></FontAwesomeIcon>
                <Link href={{
                    pathname: '/'
                }}>
                    ¿Quíenes somos?

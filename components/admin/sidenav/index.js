...
import ContainerRight from "../container-rigth";
    ...
    <>
      <div className="flex justify-between items-center">
        <div className="bg-gray-200 w-64">
          <div className="w-64 h-screen bg-gray-800 sm:mt-0">
            <div className="flex items-center justify-center">
              <p className="text-gray-100 pt-5">PANEL ADMIN</p>
            </div>

            <nav className="mt-10">
              <div className="flex items-center py-2 px-8 bg-gray-700 text-gray-100 border-r-4 border-gray-100 hover:cursor-pointer">
                <svg
                  className="h-5 w-5"
                  viewBox="0 0 24 24"
                  fill="none"
              ...
              <div className="flex items-center mt-5 py-2 px-8 text-gray-400 border-r-4 border-gray-800 hover:bg-gray-700 hover:text-gray-100 hover:border-gray-100 hover:cursor-pointer">
                  <svg
                    className="h-5 w-5"
                    viewBox="0 0 24 24"
                    fill="none"
            ...
            <div className="absolute bottom-0 my-10">
              ...
              <div className="flex items-center py-2 px-8 text-gray-600 hover:text-gray-500 hover:cursor-pointer">
                  <svg
                    className="h-5 w-5"
                    viewBox="0 0 20 20"
                    fill="none"
